...
def finden_der_richtigen_konjugationsart(i : str,a : str,t : str,n : str,p : str,g : str,vocabel : str):
    if vocabel in ausnahmen:
        ...
        funktionsliste_dict = {"a_konjugtion":{'indikativ': {'aktiv': {'plusquamperfekt': a_konj_ind_akt_plus(n,p,g,stammformen[2]), 'perfekt': a_konj_ind_akt_perf(n,p,g,stammformen[2]),'imperfekt': a_konj_ind_akt_imperf(n,p,g,stammformen[0]), 'präsens': a_konj_ind_akt_prä(n,p,g,stammformen[0]), 'futur': a_konj_ind_akt_fut(n,p,g,stammformen[0]), 'futur2': a_konj_ind_akt_fut2(n,p,g,stammformen[0])},
        'passiv': {'plusquamperfekt': a_konj_ind_pas_plus(n,p,g,stammformen[0]), 'perfekt': a_konj_ind_pas_perf(n,p,g,stammformen[0]), 'imperfekt': a_konj_ind_pas_imperf(n,p,g,stammformen[0]), 'präsens': a_konj_ind_pas_prä(n,p,g,stammformen[0]), 'futur': a_konj_ind_pas_fut(n,p,g,stammformen[0]), 'futur2': a_konj_ind_pas_fut2(n,p,g,stammformen[0])}},
        'konjungtiv': {'aktiv': {'plusquamperfekt': a_konj_konj_akt_plus(n,p,g,stammformen[2]), 'perfekt': a_konj_konj_akt_perf(n,p,g,stammformen[2]), 'imperfekt': a_konj_konj_akt_imperf(n,p,g,stammformen[0]), 'präsens': a_konj_konj_akt_prä(n,p,g,stammformen[0]), 'futur': "", 'futur2': ""},
        'passiv': {'plusquamperfekt': a_konj_konj_pas_plus(n,p,g,stammformen[0]), 'perfekt': a_konj_konj_pas_perf(n,p,g,stammformen[0]), 'imperfekt': a_konj_konj_pas_imperf(n,p,g,stammformen[0]), 'präsens': a_konj_konj_pas_prä(n,p,g,stammformen[0]), 'futur': "", 'futur2': ""}}}}
...
print(json.dumps(konjugieren([],[],[],[],[],[],"laudare"),indent=2))
