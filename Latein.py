...
def a_konj_ind_pas_perf(n : str,p : str,g : str,vocabel : str):
    ...
    grundform = vocabel.rstrip("re")
    return grundform  + sonderzeichen[g][n] + konjugieren(["indikativ"],["aktiv"],["präsens"],[n],[p],["mänlich"],"esse")["indikativ"]["aktiv"]["präsens"]["mänlich"][n][p]

def a_konj_ind_pas_plus(n : str,p : str,g : str,vocabel : str):
    sonderzeichen = {"mänlich":{"Sing":"tus ","Pl":"ti "},"weiblich":{"Sing":"ta ","Pl":"tae "}}
    grundform = vocabel.rstrip("re")
    return grundform  + sonderzeichen[g][n] + konjugieren(["indikativ"],["aktiv"],["imperfekt"],[n],[p],["mänlich"],"esse")["indikativ"]["aktiv"]["imperfekt"]["mänlich"][n][p]
