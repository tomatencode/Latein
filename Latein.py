...
def a_konj_konj_pas_perf(n : str,p : str,g : str,vocabel : str):
    sonderzeichen = {"mänlich":{"Sing":"tus ","Pl":"ti "},"weiblich":{"Sing":"ta ","Pl":"tae "}}
    grundform = vocabel.rstrip("re")
    return grundform  + sonderzeichen[g][n] + konjugieren(["konjungtiv"],["aktiv"],["präsens"],[n],[p],["mänlich"],"esse")["konjungtiv"]["aktiv"]["präsens"]["mänlich"][n][p]

def a_konj_konj_pas_plus(n : str,p : str,g : str,vocabel : str):
    sonderzeichen = {"mänlich":{"Sing":"tus ","Pl":"ti "},"weiblich":{"Sing":"ta ","Pl":"tae "}}
    grundform = vocabel.rstrip("re")
    return grundform  + sonderzeichen[g][n] + konjugieren(["konjungtiv"],["aktiv"],["imperfekt"],[n],[p],["mänlich"],"esse")["konjungtiv"]["aktiv"]["imperfekt"]["mänlich"][n][p]
